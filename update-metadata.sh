...
subxt metadata --url wss://sys.turboflakes.io:443/people-polkadot -f bytes > packages/chains/people-polkadot/artifacts/metadata/people_polkadot_metadata.scale
