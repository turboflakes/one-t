...
subxt metadata --url wss://people-paseo.rpc.amforc.com:443 -f bytes > packages/chains/people-paseo/artifacts/metadata/people_paseo_metadata.scale
subxt metadata --url wss://people-paseo.turboflakes.io:443 -f bytes > packages/chains/people-paseo/artifacts/metadata/people_paseo_metadata_1.scale
# ****** AssetHub Chains ******
